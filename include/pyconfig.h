...
/* Modified by hand for compatibility with Unikraft; entries marked
 * 'UNIKRAFT' are purposely different from autoconfigured values.
 * When updating, take care to integrate and verify new flags.
 */
